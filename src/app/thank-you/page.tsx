...
const ThankYouPage = async ({ searchParams }: PageProps) => {
  ...
  if (orderUserId !== user?.id) {
    return redirect(`/sign-in?origin=thank-you?order-Id=${order.id}`);
  }
  ...
  return (
    <main className="relative lg:min-h-full">
      ...
      <div className="">
        <div className="mx-auto max-2xl: px-4 py-16 sm:px-6 sm:py-24 lg:grid lg: max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-24">
